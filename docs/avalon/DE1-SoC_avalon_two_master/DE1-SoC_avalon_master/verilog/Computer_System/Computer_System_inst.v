	Computer_System u0 (
		.external_master_external_interface_address       (<connected-to-external_master_external_interface_address>),       //   external_master_external_interface.address
		.external_master_external_interface_byte_enable   (<connected-to-external_master_external_interface_byte_enable>),   //                                     .byte_enable
		.external_master_external_interface_read          (<connected-to-external_master_external_interface_read>),          //                                     .read
		.external_master_external_interface_write         (<connected-to-external_master_external_interface_write>),         //                                     .write
		.external_master_external_interface_write_data    (<connected-to-external_master_external_interface_write_data>),    //                                     .write_data
		.external_master_external_interface_acknowledge   (<connected-to-external_master_external_interface_acknowledge>),   //                                     .acknowledge
		.external_master_external_interface_read_data     (<connected-to-external_master_external_interface_read_data>),     //                                     .read_data
		...
		.system_pll_100_clk_clk                           (<connected-to-system_pll_100_clk_clk>),                           //                   system_pll_100_clk.clk
		.external_master_2_external_interface_address     (<connected-to-external_master_2_external_interface_address>),     // external_master_2_external_interface.address
		.external_master_2_external_interface_byte_enable (<connected-to-external_master_2_external_interface_byte_enable>), //                                     .byte_enable
		.external_master_2_external_interface_read        (<connected-to-external_master_2_external_interface_read>),        //                                     .read
		.external_master_2_external_interface_write       (<connected-to-external_master_2_external_interface_write>),       //                                     .write
		.external_master_2_external_interface_write_data  (<connected-to-external_master_2_external_interface_write_data>),  //                                     .write_data
		.external_master_2_external_interface_acknowledge (<connected-to-external_master_2_external_interface_acknowledge>), //                                     .acknowledge
		.external_master_2_external_interface_read_data   (<connected-to-external_master_2_external_interface_read_data>)    //                                     .read_data
	);
