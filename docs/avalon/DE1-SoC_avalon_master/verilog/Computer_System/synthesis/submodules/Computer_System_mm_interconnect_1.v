...
module Computer_System_mm_interconnect_1 (
		...
		input  wire        Slider_Switches_reset_reset_bridge_in_reset_reset,                        //                        Slider_Switches_reset_reset_bridge_in_reset.reset
	...
	wire          slider_switches_s1_agent_rp_valid;                             // Slider_Switches_s1_agent:rp_valid -> router_002:sink_valid
	wire  [111:0] slider_switches_s1_agent_rp_data;                              // Slider_Switches_s1_agent:rp_data -> router_002:sink_data
	wire          slider_switches_s1_agent_rp_ready;                             // router_002:sink_ready -> Slider_Switches_s1_agent:rp_ready
	wire          slider_switches_s1_agent_rp_startofpacket;                     // Slider_Switches_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          slider_switches_s1_agent_rp_endofpacket;                       // Slider_Switches_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          cmd_mux_src_valid;                                             // cmd_mux:src_valid -> Slider_Switches_s1_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_src_data;                                              // cmd_mux:src_data -> Slider_Switches_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                             // Slider_Switches_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                           // cmd_mux:src_channel -> Slider_Switches_s1_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                     // cmd_mux:src_startofpacket -> Slider_Switches_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                       // cmd_mux:src_endofpacket -> Slider_Switches_s1_burst_adapter:sink0_endofpacket
	...
	wire  [111:0] slider_switches_s1_burst_adapter_source0_data;                 // Slider_Switches_s1_burst_adapter:source0_data -> Slider_Switches_s1_agent:cp_data
	...
	wire    [1:0] slider_switches_s1_burst_adapter_source0_channel;              // Slider_Switches_s1_burst_adapter:source0_channel -> Slider_Switches_s1_agent:cp_channel
	...
	wire          slider_switches_s1_agent_rdata_fifo_out_valid;                 // Slider_Switches_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] slider_switches_s1_agent_rdata_fifo_out_data;                  // Slider_Switches_s1_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          slider_switches_s1_agent_rdata_fifo_out_ready;                 // avalon_st_adapter:in_0_ready -> Slider_Switches_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                                 // avalon_st_adapter:out_0_valid -> Slider_Switches_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                                  // avalon_st_adapter:out_0_data -> Slider_Switches_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                 // Slider_Switches_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                 // avalon_st_adapter:out_0_error -> Slider_Switches_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.reset                  (Slider_Switches_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (System_PLL_sys_clk_clk),                                 //             clk.clk
		.reset                   (Slider_Switches_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (Slider_Switches_reset_reset_bridge_in_reset_reset),      // cr0_reset.reset
	...
	Computer_System_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (Slider_Switches_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
